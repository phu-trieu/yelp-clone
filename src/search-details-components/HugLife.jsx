          ...
          <div className="details-store-info">
            <div>
              ...
              <div className="details-hours-container">
                <p className="text-success fw-bold">Open</p>
                <p className="details-hours white-font fw-bold">12:00 PM - 11:00 PM</p>
                <span className="fas fa-info-circle text-primary"></span>
